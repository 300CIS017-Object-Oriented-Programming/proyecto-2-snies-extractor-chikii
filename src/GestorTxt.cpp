...
bool GestorTxt::crearArchivoTxt(string &ruta, map<int, ProgramaAcademico *> &mapadeProgramasAcademicos, vector<string> etiquetasColumnas, int ano1, int ano2)
{
    ...
    string rutaCompleta = ruta + "resultados" + rangoAno + ".txt";
